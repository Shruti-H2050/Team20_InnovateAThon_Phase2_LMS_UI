...
public BatchPageValidationPages(WebDriver driver) 
	...
	public void admin_clicks_batchbutton(String string) 
	{
		...
		driver.findElement(batchbtn).click();
	            ...
	            System.out.println("WebDriver instance is null. Cannot perform action.");
	            // Optionally, you can throw an exception or handle the null case based on your requirements
	        }
	}
