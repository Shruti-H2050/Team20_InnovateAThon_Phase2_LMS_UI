...
public class AddNewBatchPages {
	...
	{		
        ...
        List<Map<String, String>> testdata = reader.getData("C:\\RemyaProjects\\Team20_InnovateAThon_Phase2_LMS_UI\\src\\test\\resources\\exceldata\\Add batch excel data.xlsx",sheetName);  
