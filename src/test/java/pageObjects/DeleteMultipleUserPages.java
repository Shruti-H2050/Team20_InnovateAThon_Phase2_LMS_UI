...
public class DeleteMultipleUserPages {
	public WebDriver driver;

	By manageUsrPage = By.xpath("//*[contains(text(),'Manage User')]");
	...
	public DeleteMultipleUserPages(WebDriver driver) {
		this.driver = driver;
	}
	
	public void onManageUserPage() {
		driver.findElement(manageUsrPage).isDisplayed();
	}
